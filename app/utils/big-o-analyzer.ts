...
// Language-specific patterns (only for languages with known library patterns)
const languagePatterns: Partial<Record<Language, Record<string, RegExp>>> = {
  cpp: {
    stlSort: /\bsort\s*\(/g,
    stlFind: /\bfind\s*\(/g,
