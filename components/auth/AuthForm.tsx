  ...
  return (
    <div className="space-y-4">
      ...
      <button
        ...
        disabled={loading}
        className="w-full p-3 bg-white text-gray-800 rounded-lg flex items-center justify-center gap-2 hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
      >
